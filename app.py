...
products = [
    ...
    {"id": 10, "name": "Nike Air VaporMax 2021", "price": 100, "availability": 4, "description": "Embrace sustainability with the Nike Air VaporMax 2021, featuring at least 50% recycled content by weight. Its airy, cushioned feel delivers a gravity-defying sensation, perfect for the eco-conscious runner seeking comfort and performance.", "image": "../static/images/products/product-1.jpg"},
    {"id": 11, "name": "Nike ZoomX Vaporfly", "price": 200, "availability": 6, "description": "Experience unmatched speed and responsiveness with the Nike ZoomX Vaporfly. Engineered for record-breaking speed, this elite race shoe features revolutionary ZoomX foam and a carbon fiber plate to propel you towards the finish line faster than ever.", "image": "../static/images/products/product-2.jpg"},
    {"id": 12, "name": "Nike Blazer Mid '77", "price": 300, "availability": 3, "description": "Retro meets modern in the Nike Blazer Mid '77. This classic silhouette blends a vintage mid-cut with lush suede and a timeless design. Perfect for those looking to add a stylish yet comfortable touch to their everyday wear.", "image": "../static/images/products/product-3.jpg"},
    {"id": 13, "name": "Nike Air Force 1", "price": 400, "availability": 5, "description": "A streetwear staple since 1982, the Nike Air Force 1 remains an icon of style and comfort. With its durable foam midsole and pivot point outsole, it's designed to provide premium all-day comfort and agile movement.", "image": "../static/images/products/product-4.jpg"},
    {"id": 14, "name": "Nike Air Max 90", "price": 500, "availability": 10, "description": "The Nike Air Max 90 stays true to its roots with the iconic Waffle sole, stitched overlays, and classic TPU accents. Known for its outstanding cushioning, it's designed to keep you looking and feeling great on your feet.", "image": "../static/images/products/product-5.jpg"},
    {"id": 15, "name": "Nike Glide FlyEase", "price": 600, "availability": 12,"description": "Nike Glide FlyEase offers a seamless blend of comfort and accessibility with its innovative lace-free design. Engineered for easy on and off, it's ideal for athletes of all abilities who don't want to compromise on performance or style.", "image": "../static/images/products/product-6.jpg"},
    {"id": 16, "name": "Nike Zoom Freak", "price": 700,"availability": 1, "description": "Unleash your inner Giannis Antetokounmpo with the Nike Zoom Freak. Designed with two Zoom Air units for explosive movements, this shoe offers a snug fit and multidirectional traction to dominate the court just like the MVP himself.", "image": "../static/images/products/product-7.jpg"},
    {"id": 17, "name": "Nike Air Pegasus", "price": 800, "availability": 2,"description": "The Nike Air Pegasus continues its legacy as a runner's best friend with added comfort and durability. This all-time favorite is designed for every runner, providing long-lasting stability and breathable comfort for extended training.", "image": "../static/images/products/product-8.jpg"},
    {"id": 18, "name": "Nike Air Jordans", "price": 900,"availability": 0, "description": "Step into a legacy of quality and cool with the Nike Air Jordans. These sneakers offer more than just style; they're equipped with state-of-the-art cushioning technology to deliver performance that matches their iconic status.", "image": "../static/images/products/product-1.jpg"},
    {"id": 19, "name": "Nike Air VaporMax 2021", "price": 100, "availability": 4, "description": "Embrace sustainability with the Nike Air VaporMax 2021, featuring at least 50% recycled content by weight. Its airy, cushioned feel delivers a gravity-defying sensation, perfect for the eco-conscious runner seeking comfort and performance.", "image": "../static/images/products/product-1.jpg"},
    {"id": 20, "name": "Nike ZoomX Vaporfly", "price": 200, "availability": 6, "description": "Experience unmatched speed and responsiveness with the Nike ZoomX Vaporfly. Engineered for record-breaking speed, this elite race shoe features revolutionary ZoomX foam and a carbon fiber plate to propel you towards the finish line faster than ever.", "image": "../static/images/products/product-2.jpg"},
    {"id": 21, "name": "Nike Blazer Mid '77", "price": 300, "availability": 3, "description": "Retro meets modern in the Nike Blazer Mid '77. This classic silhouette blends a vintage mid-cut with lush suede and a timeless design. Perfect for those looking to add a stylish yet comfortable touch to their everyday wear.", "image": "../static/images/products/product-3.jpg"},
    {"id": 22, "name": "Nike Air Force 1", "price": 400, "availability": 5, "description": "A streetwear staple since 1982, the Nike Air Force 1 remains an icon of style and comfort. With its durable foam midsole and pivot point outsole, it's designed to provide premium all-day comfort and agile movement.", "image": "../static/images/products/product-4.jpg"},
    {"id": 23, "name": "Nike Air Max 90", "price": 500, "availability": 10, "description": "The Nike Air Max 90 stays true to its roots with the iconic Waffle sole, stitched overlays, and classic TPU accents. Known for its outstanding cushioning, it's designed to keep you looking and feeling great on your feet.", "image": "../static/images/products/product-5.jpg"},
    {"id": 24, "name": "Nike Glide FlyEase", "price": 600, "availability": 12,"description": "Nike Glide FlyEase offers a seamless blend of comfort and accessibility with its innovative lace-free design. Engineered for easy on and off, it's ideal for athletes of all abilities who don't want to compromise on performance or style.", "image": "../static/images/products/product-6.jpg"},
    {"id": 25, "name": "Nike Zoom Freak", "price": 700,"availability": 1, "description": "Unleash your inner Giannis Antetokounmpo with the Nike Zoom Freak. Designed with two Zoom Air units for explosive movements, this shoe offers a snug fit and multidirectional traction to dominate the court just like the MVP himself.", "image": "../static/images/products/product-7.jpg"},
    {"id": 26, "name": "Nike Air Pegasus", "price": 800, "availability": 2,"description": "The Nike Air Pegasus continues its legacy as a runner's best friend with added comfort and durability. This all-time favorite is designed for every runner, providing long-lasting stability and breathable comfort for extended training.", "image": "../static/images/products/product-8.jpg"},
    {"id": 27, "name": "Nike Air Jordans", "price": 900,"availability": 0, "description": "Step into a legacy of quality and cool with the Nike Air Jordans. These sneakers offer more than just style; they're equipped with state-of-the-art cushioning technology to deliver performance that matches their iconic status.", "image": "../static/images/products/product-1.jpg"},
...
def checkout():
    ...
    if not orderCanBePlaced:
        flash("Unable to place order!", category="danger")
...
@app.route('/delete_item/<int:product_id>', methods=["GET"])
def delete_item(product_id):
    global cart
    product = next((item for item in products if item['id'] == product_id), None)
    ind = cart["items"].index(product)
    cart["items"].pop(ind)
    cart["num_items"] -= 1
    cart["total_price"] -= product["price"]
    return redirect(url_for('home'))
